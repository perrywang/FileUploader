(function($){
        ...
        render:function(){
            ...
            attachingBtn.on('click',function(event){
                ...
                clickingInput.on('change', function () {
                    var itemTempalte = that.itemTempalte;                  
    ...
    var FileUploader = function(options){
        ...
        this.itemTempalte = options.itemTempalte || defaultOptions.itemTempalte;
    	this.render = options.render || defaultOptions.render;
    };
